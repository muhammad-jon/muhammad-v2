...
const DefaultSidebar: React.FC<Props> = () => {
  return (
    <aside className="defaultSidebar w-full order-1 md:order-none md:max-w-min flex flex-col flex-none">
      <Author name={AuthorConfig.name} role={AuthorConfig.role} />
      ...
      >
        <Tagline label={AuthorConfig.description} className="md:py-[5px]" />
        ...
        >
          <Badge
            ...
            className="md:w-full mr-[15px] md:mb-2 md:mr-0 justify-start"
          />
        ...
        <DefaultButton
          label="Open To Work"
          className={clsx(
            ScreenConfig.mobile.alignLeft
              ? "max-w-full !justify-start block pl-[15px]"
              : ""
          )}
        />
